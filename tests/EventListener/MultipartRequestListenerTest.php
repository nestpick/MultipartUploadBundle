...
class MultipartRequestListenerTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testAttachments()
    {
        ...
        self::assertInstanceOf(UploadedFile::class, $this->request->attributes->get('_multipart_related_1'));
        self::assertInstanceOf(UploadedFile::class, $this->request->attributes->get('_multipart_related'));
    ...
    public function testFileUploads()
    {
        ...
        self::assertEquals('size', $attachment->getClientSize());
